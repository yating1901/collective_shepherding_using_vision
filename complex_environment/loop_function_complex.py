...
from sheep_agent_complex import Sheep_Agent
from shepherd_agent_complex import Shepherd_Agent
import support
import os, json
import matplotlib.pyplot as plt

class Loop_Function_Complex:
    def __init__(self, N_sheep=10, N_shepherd = 1, Time=1000, width=500, height=500,
        ...
        self.list_of_obstacles = [{'x':750, 'y':600, 'radius':50}, {'x':600, 'y':750, 'radius':50}]  # (x,y,radius)
    ...
    def draw_obstacles(self):
        for obstacle in self.list_of_obstacles:
            pygame.draw.circle(self.screen, support.GREY, (obstacle["x"] , obstacle["y"]), obstacle["radius"])
    ...
    def save_arena_image(self):
        ...
        out_dir = os.environ.get("OUTPUT_DIR", "results/snapshots")
